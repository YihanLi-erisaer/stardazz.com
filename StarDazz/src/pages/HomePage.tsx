  ...
  return (
    <div className="relative">
      ...
      <section className="mx-auto max-w-6xl px-4 pb-24 pt-20 sm:px-6 sm:pb-32 sm:pt-28">
        <p className="mb-4 inline-flex items-center rounded-full border border-zinc-200 bg-white px-3 py-1 font-mono text-xs text-zinc-600 dark:border-white/10 dark:bg-white/[0.03] dark:text-zinc-400">
          {t('home.badge')}
        </p>
        <h1 className="max-w-4xl text-4xl font-medium tracking-tight text-zinc-900 dark:text-zinc-50 sm:text-5xl md:text-6xl md:leading-[1.08]">
          {t('home.heroTitle1')}
          <span className="block bg-gradient-to-r from-zinc-900 via-zinc-600 to-zinc-400 bg-clip-text text-transparent dark:from-zinc-100 dark:via-zinc-300 dark:to-zinc-500">
            {t('home.heroTitle2')}
          </span>
        </h1>
      ...
      >
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Link
              to="/products/smeeting"
              className="group relative overflow-hidden rounded-2xl border border-zinc-200 bg-gradient-to-br from-zinc-100 to-zinc-200 p-8 transition hover:border-zinc-300 dark:border-white/[0.08] dark:from-zinc-900/80 dark:to-zinc-950 dark:hover:border-white/[0.14] dark:hover:shadow-[0_0_0_1px_rgba(255,255,255,0.06)]"
            >
            ...
            <div className="flex flex-col justify-center rounded-2xl border border-dashed border-zinc-300 bg-zinc-100/40 p-8 text-center dark:border-white/[0.1] dark:bg-zinc-950/40">
