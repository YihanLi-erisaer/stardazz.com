...
export const messages = {
  zh: {
    ...
    about: {
      ...
      sampleMd: [
        '# 关于我',
        '',
        '你好，这里是 **StarDazz** 的示例介绍，你可以在左侧自由修改这段文字。',
        '',
        '## 现在在做什么',
        '- 设计与发布生产力工具',
        '- 开源项目：[smeeting](https://github.com/YihanLi-erisaer/smeeting)',
        '',
  ...
  en: {
    ...
    about: {
      ...
      subtitle:
        'StarDazz Personal Software Developer, StarDazz Video Channel Operator ',
      crumbHome: 'Home',
      ...
      sampleMd: [
        '# Yihan Li',
        '',
        '[Liyihan11unique@outlook.com](mailto:Liyihan11unique@outlook.com) · [LinkedIn](https://www.linkedin.com/in/yihan-li-b882593b3/) · [Personal Website](https://stardazz-com.vercel.app/)',
        '',
        '## Tech Stack',
        '',
        '**Languages**',
